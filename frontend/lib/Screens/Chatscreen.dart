...
import 'package:frontend/CustomUI/ReplyMessageCard.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        isDark
            ? Image.asset(
                "assets/whatsapp_light_bg.jpg",
                height: MediaQuery.of(context).size.height,
                width: MediaQuery.of(context).size.width,
                fit: BoxFit.cover,
              )
            : Image.asset(
                "assets/whatsapp_dark_bg.jpg",
                height: MediaQuery.of(context).size.height,
                width: MediaQuery.of(context).size.width,
                fit: BoxFit.cover,
              ),
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  iconCreation(
                      Icons.insert_drive_file, Colors.indigoAccent, "Docments"),
                  iconCreation(Icons.camera_alt, Colors.pink, "Camera"),
                  iconCreation(
                      Icons.insert_photo_rounded, Colors.deepPurple, "Gallery"),
                ],
              ),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
